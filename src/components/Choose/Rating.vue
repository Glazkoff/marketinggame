  ...
  <div class="card p-xl-4 p-3">
    ...
    <div class="">
      <div class="d-flex mt-1 pt-2 pb-2 text-info font-weight-bolder text-center align-items-center">
        <span class="col-6 col-sm-3">Место</span>
        <span class="col-6 col-sm-3">Игрок</span>
        <span class="col-2 d-none d-sm-block"><img width="32px" src="@/assets/1.svg" alt="First" title="Первые места"></span>
        <span class="col-2 d-none d-sm-block"><img width="32px" src="@/assets/2.svg" alt="Second" title="Вторые места"></span>
        <span class="col-2 d-none d-sm-block"><img width="32px" src="@/assets/3.svg" alt="Third" title="Третьи места"></span>
      </div>
      ...
      >
        <span class="col-6 col-sm-3 font-weight-bolder"
              :style="{color: placeColor[index]}"
        >
          {{ user.id + 1 }}</span>
        <span class="col-6 col-sm-3">{{ user.name }}</span>
